    ...
    for run_dir in run_dirs:
        ...
        for exp_dir in exp_dirs:
            ...
            try:
                ...
                # **NEW**: Add a boolean column for coverage
...
def main():
    parser = argparse.ArgumentParser(description="Create simplified bias and coverage analysis plots.")
    ...
    # 1. Load raw data and calculate metrics
