...
def produce_plots(df: pd.DataFrame, fig_dir: str) -> None:
    ...
    cf_probas_hist_dir = join(hist_fig_dir, "cf_probas")
    ...
    plot_probas_hist(
        ...
        "cf_probas_by_exposure",
        save_dir=cf_probas_hist_dir,
    )
    plot_probas_hist(
        df,
        CF_PROBAS,
    ...
    plot_probas_hist(
        ...
        EXPOSURE_COL,
        ("Control", "Exposed"),
        "Counterfactual - Factual: Control vs Exposed",
    ...
    ps_hist_dir = join(hist_fig_dir, "ps")
    os.makedirs(ps_hist_dir, exist_ok=True)
    plot_probas_hist(
        df,
        PS_COL,
        EXPOSURE_COL,
    ...
    cf_fig_dir = join(fig_dir, "cf_probas")
